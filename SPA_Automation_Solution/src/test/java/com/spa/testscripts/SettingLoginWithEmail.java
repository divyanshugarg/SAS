...
public class SettingLoginWithEmail extends SAS_Engine {
	HomeScreen objHomeScreen = null ;
	boolean passflag = true;
	String testScriptErrorMessage = "";
	
  @Test(priority = 2,description ="Verify user can login by registered email id")
  public void LoginwithEmail() 
  {
	   SettingScreen objSetting = objHomeScreen.setting();
	   AccountScreen objAccount = objSetting.clickonAccount();
	   objAccount.EmailTextEnter();
	   objAccount.PasswordTextEnter();
	   objAccount.ClickonLogin();
  }
